...
public class HotSale implements Serializable{
    ...
    private String tradeGrowthRange;

    private String tradeGrowthRangeCrc;
    ...
    public String getTradeGrowthRange() {
        return tradeGrowthRange;
    }

    public void setTradeGrowthRange(String tradeGrowthRange) {
        this.tradeGrowthRange = tradeGrowthRange == null ? null : tradeGrowthRange.trim();
    }

    public String getTradeGrowthRangeCrc() {
        return tradeGrowthRangeCrc;
    }

    public void setTradeGrowthRangeCrc(String tradeGrowthRangeCrc) {
        this.tradeGrowthRangeCrc = tradeGrowthRangeCrc == null ? null : tradeGrowthRangeCrc.trim();
    }
    ...
    public String getPayRateIndex() {
        return payRateIndex;
    }

    public void setPayRateIndex(String payRateIndex) {
        this.payRateIndex = payRateIndex == null ? null : payRateIndex.trim();
    }
